	    ...
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xm-12" >
	       <div class="boxdiv" style=" background-color:rgba(0,0,128,0.1);color:white;min-height:600px;padding-left:20px;padding-top:20px;padding-left:5px;margin:1px">
				    ...
				    <nav class="navbar navbar-default " role="navigation" style="width:1290px;margin-left:10px; margin-top:0px;">
                        <div class="navbar-header">
						   ...
						   <ul class="nav nav-pills " id="u1">
								...
								<li style="padding-left:30px"><a href="staff.php">Staff</a></li>
                                <li class="active" style="padding-left:30px"><a href="subject.php">Subject</a></li>								
                            </ul>
              ...
              <div class="boxdiv" style="color:white;min-height:700px;padding-left:20px;padding-top:20px;margin:2px">
                 ...
                 <form action="admintoadd_p3.php" method="post">
						<div id="d1">
							
                            <label class="l1" >CourseId</label><input class="s1" type="text" name="addCourseId" placeholder="Enter courseId" /><br />
							<label class="l1">CourseName</label><input class="s1" type="text" name="addCourseName" placeholder="Enter courseName" /><br />
	
							<input type="submit" class="select" style="width:250px;height:40px"name="addSubject" value="ADD SUBJECT" /><br /><br />
                             <hr/>
							<label class="l1">CourseId</label><input class="s1" type="text" name="deleteCourseId" placeholder="Enter courseId" /><br />
							<input type="submit" class="select" style="width:250px;height:40px" name="deleteSubject" value="DELETE SUBJECT" /><br /><br />
                             <hr/>
							<input type="submit" class="select"style="width:250px;height:40px;margin-bottom:20px;" name="showSubject" value="SHOW SUBJECT" /><br />			 
						</div>
                ...
                foreach($_SESSION["courseId"] as $qqq){?>
									   ...
									   <td ><font color="green"><?php echo $_SESSION["courseId"][$i]; ?></td>
									   <td ><font color="red"><?php echo $_SESSION["courseName"][$i]; ?></td>
