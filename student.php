	    ...
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xm-12" >
	       <div class="boxdiv" style=" background-color:rgba(0,0,128,0.1);color:white;min-height:600px;padding-left:20px;padding-top:20px;padding-left:5px;margin:1px">
				    ...
				    <nav class="navbar navbar-default " role="navigation" style="width:1290px;margin-left:10px; margin-top:0px;">
                        <div class="navbar-header">
						   ...
						   <ul class="nav nav-pills " id="u1">
                                ...
                                <li class="active" style="padding-left:30px" ><a href="student.php">Student</a></li>
              ...
              <div class="boxdiv" style="color:white;min-height:700px;padding-left:20px;padding-top:20px;margin:2px">
				 ...
				 <?php session_start(); ?>                          
                 <form action="admintoadd_p1.php" method="post">
						<div id="d1">
							
                            <label class="l1" >regNo</label><input class="s1" type="text" name="addRegNo" placeholder="Enter regNo" /><br />
							...
							<input type="submit" class="select" style="width:250px;height:40px"name="addStudent" value="ADD STUDENT" /><br /><br />
                             <hr/>
							<label class="l1">regNo</label><input class="s1" type="text" name="deleteRegNo" placeholder="Enter regNo" /><br />
							<input type="submit" class="select" style="width:250px;height:40px" name="deleteStudent" value="DELETE STUDENT" /><br /><br />
                             <hr/>
							<input type="submit" class="select"style="width:250px;height:40px;margin-bottom:20px;" name="showStudent" value="SHOW STUDENT" /><br />							 
						</div>
				...
				<?php if(isset($_SESSION["sturegNo"])){?>
            				<table  id="t1">
								   ...
								   <tr>
									   ...
									   <td ><font color="green"><?php echo $_SESSION["sturegNo"][$i]; ?></td>
									   <td ><font color="red"><?php echo $_SESSION["stuname"][$i]; ?></td>
										<td><?php echo $_SESSION["stuphoneNo"][$i]; ?></td>
									   <td style="font-variant:none"><font color="purple"><?php echo $_SESSION["stuemail"][$i]; ?></td>
								   </tr>
